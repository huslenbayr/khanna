    ...
    <article className="post-card">
      ...
      {post.media_url ? (
        post.media_type === 'video' ? (
          <video key={post.media_url} src={post.media_url} controls playsInline webkit-playsinline="true" preload="metadata" className="w-full max-h-[280px] block bg-[#020617]" />
        ) : (
